...
class TabProductos extends StatelessWidget {
  ...
  final String precio;
  TabProductos(this.marca_auto, this.modelo_auto, this.nombre_pieza,
  ...
  List<DataColumn> _createColumns() {
    return [
      DataColumn(label: Text("Id de Producto")),
  ...
  List<DataRow> _createRows() {
    return [
      DataRow(cells: [
        DataCell(Text("Nombre del Producto")),
